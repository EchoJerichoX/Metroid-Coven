...
user in an INI file next to wxMP3gainPortable.exe called wxMP3gainPortable.ini.
...
copy AppNamePortable.ini from this directory to wxMP3gainPortable.ini next to
wxMP3gainPortable.exe. The options in the INI file are as follows:
